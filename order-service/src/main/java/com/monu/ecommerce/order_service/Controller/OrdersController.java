package com.monu.ecommerce.order_service.Controller;
...
import com.monu.ecommerce.order_service.service.OrdersService;
...
public class OrdersController {
    ...
    @GetMapping("/test-stock/{productId}")
    public String testStock(@PathVariable Long productId) {
        return inventoryOpenFeignClient.checkStock(productId);
    }
